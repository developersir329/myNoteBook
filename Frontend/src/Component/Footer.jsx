        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-start space-x-3">
              <a
                href="https://github.com/developersir329?tab=repositories"
                target="_blank"
                title="GitHub"
              ...
              <a
                href="https://www.instagram.com/manjeetsharma7302?igsh=MW9ncjA2b3VjMjVocQ=="
                target="_blank"
                title="Instagram"
              ...
              <a
                href="https://www.facebook.com/share/1DdXbvB46Y/"
                target="_blank"
                title="Facebook"
                className="flex items-center p-1"
              >
