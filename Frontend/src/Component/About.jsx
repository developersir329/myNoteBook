...
function About() {
  const {darkMode} = useAuthState();
  return (
    <section className= {`dark:bg-gray-100 px-12 md:px-6 dark:text-gray-800 ${darkMode ? "bg-gray-800 text-white":"bg-gray-200 text-black"}`}>
      ...
      <div className="container flex flex-col-reverse justify-center py-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
        <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
          ...
          <p className="mt-6 mb-8 text-lg sm:mb-12">
            myNoteBook is made from the pain of writing all the things in
            notebook which is very hectic So we mad an online web platform where
            you can create, edit, upload, delete your notes/information
            privately and securely without any disturbancee. you can also access
            your notes anywhere in your world, at anytime time . So dont forget
            to Create note because creating anything is always important
          </p>
          <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
            <Link className="px-8 py-3 text-lg font-semibold border rounded bg-rose-500 text-white dark:border-rose-800">
              Create New Note
            </Link>
          </div>
        </div>
      ...
      <div className="container flex flex-col justify-center py-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
        ...
        <div className="flex flex-col justify-center py-6 pr-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
          ...
          <p className="mt-6 mb-8 text-lg sm:mb-12">
            How we started? The concept was simple. myNoteBook was born from the
            pain of writing all the things in notebook which is very hectic. An
            online web platform where you can create, edit, upload, delete your
